function im_rec = tomo_reconstruction_myart(projmat_art,angles,n_iter)
%  Tomographic reconstruction using Algebraic Reconstruction Techniques 
%   (ART) in x and y directions.
